...
handob = handlungsschritt(text="1. Wirsing putzen, waschen und in Streifen, Kasseler in Würfel schneiden. Zwiebeln abziehen und in Ringe schneiden. Öl erhitzen, Zwiebeln dazugeben, goldbraun braten und herausnehmen. Wirsing in das verbliebene Bratfett geben und andünsten. Brühe angießen, Kasseler und gebratene Zwiebeln dazugeben und abgedeckt ca. 20 Min. garen.2. Schupfnudeln und Schmand untermischen und alles mit Senf, Liebstöckel, Salz, Pfeffer und Kümmel abschmecken.3. Mischung in eine Gratinform (20 x 30 cm) geben, Käse überstreuen und im vorgeheizten Backofen bei 200 °C (Gas: Stufe 4, Umluft 180 °C) ca. 25-30 Min. goldbraun überbacken. Schnittlauch überstreuen und servieren.Pro Portion (bei 6 Portionen):kJ/kcal: 2.322/555EW: 24,3 gF: 24,5 gKH: 59,2 gBE: 4,5")
db.session.add(handob)
db.session.commit()
