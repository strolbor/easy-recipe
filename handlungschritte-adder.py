...
handob = handlungsschritt(text="F: 12,0 g")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(9)
...
handob = handlungsschritt(text="BE: 1,5")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(9)
...
handob = handlungsschritt(text="F: 29,3 g")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(19)
assoc = AssociationRHhat(position=7)
...
handob = handlungsschritt(text="BE: 2,5")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(19)
assoc = AssociationRHhat(position=9)
...
handob = handlungsschritt(text="Tipp:")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(20)
assoc = AssociationRHhat(position=6)
...
handob = handlungsschritt(text="F: 12,8 g")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(23)
assoc = AssociationRHhat(position=10)
...
handob = handlungsschritt(text="BE: 3,5")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(23)
...
handob = handlungsschritt(text="F: 47,0 g")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(29)
assoc = AssociationRHhat(position=7)
...
handob = handlungsschritt(text="BE: 5,0")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(72)
assoc = AssociationRHhat(position=13)
...
handob = handlungsschritt(text="F: 24,5 g")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(73)
assoc = AssociationRHhat(position=7)
...
handob = handlungsschritt(text="BE: 4,5")
db.session.add(handob)
db.session.commit()
rezaus = rezept.query.get(73)
assoc = AssociationRHhat(position=9)
