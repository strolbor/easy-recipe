...
handob = handlungsschritt(text="1. Zwiebel abziehen und in kleine Wuerfel schneiden. Hackfleisch und Zwiebeln in erhitztem Öl ca. 5 Minuten anbraten, mit Senf und Ketchup verruehren, mit Salz und Pfeffer abschmecken und auskuehlen lassen.2. Tomaten waschen und vierteln, Gurken grob hacken. Pizzateig entrollen und in 12 Rechtecke schneiden (ca. 9 x 9 cm). Hackfleisch-Mischung, Cheddar, Tomaten und Gurken mittig auf den Teigstuecken verteilen und Teig ueber der Fuellung zusammenfalten. Teigraender gut zusammendruecken, sodass keine Öffnung mehr bleibt und mit der verschlossenen Seite nach unten in gefettete Mulden eines Muffinblechs legen.3. Muffins mit Milch bestreichen, mit Sesam bestreuen und im vorgeheizten Backofen bei 180 °C (Umluft: 160 °C) ca. 35 Minuten backen. Cheese-Burger-Muffins etwas abkuehlen lassen, aus der Form loesen und lauwarm, nach Wunsch mit Burgersauce und Ketchup, servieren.Pro Stueck:kJ/kcal: 917/220EW: 10,9 gF: 12,0 gKH: 16,8 gBE: 1,5")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Die Zutaten fuer den Knetteig in eine Schuessel geben, rasch zusammenkneten und zur Seite stellen.Fuer die Fuellung Margarine, Zucker, Vanillezucker, Puddingpulver und Eier in einer Schuessel verruehren. Dann den Quark und die saure Sahne untermischen. Die suesse Sahne steif schlagen und unterheben.Den Backofen auf 180 °C Ober-/Unterhitze vorheizen.Den Knetteig in einer gefetteten 26er Springform auslegen, etwa 2 - 3 cm am Rand hochziehen. Nun die Fuellung in die Form geben, glatt streichen und im heissen Backofen 1 Stunde backen.Achtung: Den Kuchen erst nach dem voelligen Erkalten aus der Form nehmen, da unmittelbar nach dem Herausnehmen aus dem Backofen die Konsistenz der Quarkmasse noch zu weich ist.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Fuer die Lasagneplatten zuerst die sechs Eier aufschlagen und verquirlen. Ein Backblech mit einem Backpapier auslegen, Eiermasse darauf geben und moeglichst gleichmaessig verteilen. Das Blech in den heissen Ofen schieben und die Eier bei 80 bis 100 °C Ober-/Unterhitze stocken lassen. Immer wieder mal rein schauen und gerne die Masse zwischendurch wieder glatt auf dem gesamten Blech verteilen, damit eine gleichmaessige Platte entsteht.Fuer die Hackfleischfuellung inzwischen die Zwiebeln schaelen und hacken, dann glasig anbraten. Das Hackfleisch hinzugeben. Das Fleisch mit etwas Salz und Pfeffer wuerzen und braten. Anschliessend mit den gehackten oder frischen Tomaten und den passierten Tomaten abloeschen. Jetzt nach Belieben abschmecken und ziehen lassen. Ich nutze gerne Oregano, Basilikum, Thymian, eigentlich alles, was gruen ist und vorhanden ist.Fuer die Béchamelsauce ein wenig Öl heiss werden lassen und mit der Messerspitze Mehl vermengen. Mit der Sahne und ggf einem Schuss Wasser abloeschen und cremig ruehren. Mit Salz, Pfeffer und Muskat wuerzen. Die Crème fraîche hinzugeben und zur Seite stellen.Nun die Eiermasse in Scheiben schneiden, die der genutzten Auflaufform entsprechen. Jetzt abwechselnd mit der Hackfleischsauce, Sauce Béchamel und Lasagneplatten in der Auflaufform stapeln. Die letzte Schicht sollte die Bechamel sein, welche dann mit Kaese ueberstreut wird.Alles dann so lange bei 180 °C Ober-/Unterhitze im heissen Ofen backen, bis der Kaese goldbraun ist. Da alle Zutaten bereits gar sind, ist die Backzeit variabel, am besten schmeckt es mir so nach circa 20 Minuten.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="1. Filet trocken tupfen und in 8 Medaillons schneiden. Mit Senf bestreichen, mit Schinken umwickeln und in eine kleine Auflaufform legen.2. Champignons abtropfen lassen und in der Auflaufform zwischen den Medaillons verteilen. Mit Salz und Pfeffer wuerzen und Kraeuter ueberstreuen.3. Fuer die Sauce Sahne und Crème fraîche verruehren, mit Paprikapulver, Salz und Pfeffer wuerzen, ueber die Medaillons giessen und im vorgeheizten Backofen bei 200 °C (Gas: Stufe 4, Umluft 180 °C) ca. 30 Minuten garen. Spaetzle nach Packungsanweisung zubereiten und zu dem Filet servieren.Pro Portion:kJ/kcal: 2503/598EW: 51,6 gF: 29,3 gKH: 30,2 gBE: 2,5")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Den Backofen auf 200 °C Ober-/Unterhitze vorheizen.Ein Backblech mit Backpapier auslegen. Mit nicht zu wenig Olivenoel bestreichen. Die Kartoffeln in duenne Scheiben gefaechert auf dem gefetteten Papier auslegen. Zwischen den Reihen etwas Platz lassen.Geschaelten Knoblauch waagerecht halbieren und wie den Rosmarin unter die Kartoffelscheiben legen. Salzen, pfeffern und die Kartoffelscheiben noch mal mit Öl bestreichen.Auf mittlerer Hoehe die Kartoffeln 35 min bei 200°C backen. Sie sollten leicht knusprig und leicht gebraeunt sein.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Das Rezept stammt von einer Chinareise aus der Stadt Chongqing.Zunaechst den Boden des Wok grosszuegig mit Öl bedecken und dieses auf hoechster Stufe erhitzen. Das Geschnetzelte rundherum mit Mehl bestaeuben und im Wok scharf anbraten, dann salzen. Das Fleisch herausnehmen, evtl. etwas Öl nachgeben und die gehackten Erdnuesse leicht anbraten. Die Erdnuesse herausnehmen und die Zwiebeln anbraten. Anschliessend den gehackten Knoblauch hinzugeben und ebenfalls anbraten. Die Fruehlingszwiebeln und die Chilischoten in Streifen schneiden und hinzugeben. Den Zucker darueber streuen und karamellisieren lassen.Fleisch und Erdnuesse wieder hinzugeben. Mit Wein abloeschen, aufkochen lassen und den Essig hinzugeben. Abschliessend mit Sojasauce, Ingwer und Pfeffer (gut zerkleinern, sehr intensiv!) wuerzen und abschmecken.Auf Reis servieren.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Backofen auf 180°C vorheizen.Paprikaschoten halbieren, putzen, waschen und in Stuecke schneiden. Zwiebeln abziehen und in feine Ringe schneiden. Sauerkraut abtropfen lassen und gut ausdruecken.Hackfleisch in erhitztem Öl von allen Seiten anbraten. Paprika, Zwiebeln und Kartoffelnudeln hinzugeben, anduensten und mit Sauerkraut in eine Auflaufform geben. Schmand mit Milch verruehren, mit Salz und Pfeffer abschmecken, ueber die Zutaten giessen, mit Kaese bestreuen und im vorgeheizten Backofen ca. 20-30 Min. backen (Gas: Stufe 3, Umluft: 160°C).Pro Portion:kj/kcal: 3232/774EW: 39,3 gF: 47,0 gKH: 45,0 gBE: 3,5")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Den Reis nach Packungsanleitung kochen.Das Fleisch haeuten, waschen und in spielwuerfelgrosse Stueckchen schneiden. Mit etwas Öl in der Pfanne anbraten. Wenn es leicht Farbe bekommt, den Honig dazu geben. Fruehlingszwiebeln und Knoblauch dazu, kurz mit anschwitzen. Die Ananas abtropfen lassen und den Saft auffangen, dann die Ananasstuecke mit in die Pfanne geben und auch kurz mit anschwitzen. Den Curry dazu geben und kurz alles durchroesten.Mit Sahne abloeschen. Den Schmelzkaese in Stueckchen dazu geben und schmelzen lassen. Alles aufkochen lassen, mit Salz, Pfeffer, Curry, Instantbruehe, etwas gemahlenem Chili und dem Ananassaft abschmecken und dann auf dem Reis servieren.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Das Huehnerfleisch in mundgerechte Wuerfel schneiden, die Zwiebel klein hacken, die Knoblauchzehen fein hacken, die Kardamomkapseln zerdruecken und mit den Nelken im Moerser klein mahlen.Das Öl in einem mittelgrossen Topf erhitzen, Zwiebeln und das Nelken-Kardamom-Gemisch darin anduensten und glasig werden lassen. Jetzt Huehnerfleisch, Knoblauch und das Ingwerpueree dazugeben und weitere 4 Minuten unter Ruehren durchbraten. Die restlichen Gewuerze dazugeben, einige Minuten weiterruehren und dabei das Ganze sehr gut durchmischen und durchkochen lassen. Tomatenpueree, Mandelmehl, Bruehe und Sahne nacheinander einruehren, aufkochen und bei kleiner Flamme dann 15 - 20 Minuten koecheln lassen, bis eine dick-cremige Konsistenz erreicht ist.Dazu passen Reis oder Naan-Brot.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Gefluegelfleisch, Champignons und Tomaten klein schneiden.Das Fleisch in etwas Öl anbraten und mit ein wenig Chiliflocken sowie Salz und Pfeffer wuerzen. Danach die Zwiebeln und Champignons dazugeben und 3 - 4 Minuten braten. Zum Schluss die restlichen Zutaten zugeben und umruehren. Weitere 5 Minuten leicht koecheln lassen.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Den Backofen auf 170 °C Ober-/Unterhitze vorheizen.Fuer den Boden Quark, Eier und 120 g Kaese in einer Schuessel miteinander verruehren und wuerzen. Die Masse auf das mit Backpapier ausgelegte Backblech kippen und glatt streichen. 15 Minuten im heissen Ofen backen.Das Backblech herausnehmen und den Boden beliebig belegen mit z. B. Tomatensauce, Salami, Schinken, Zucchini, Champignons oder Mais. Mit 60 g Kaese bestreuen und erneut in den Ofen schieben, bis der Kaese eine schoene Farbe hat.Abkuehlen lassen, mit Rucola bestreuen und vorsichtig einrollen.Eingerollt in Alufolie mehrere Tage im Kuehlschrank haltbar.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Den Backofen auf 170 °C Ober-/Unterhitze vorheizen.Fuer den Boden Quark, Eier und 80 g vom Kaese in einer Schuessel miteinander verruehren. Die Masse auf das mit Backpapier ausgelegte Backblech kippen und glatt streichen. 15 Minuten im Ofen backen.Das Backblech herausnehmen, den Kuchenboden mit Crème fraîche bestreichen und mit Speckwuerfeln, Lauchzwiebeln und dem restlichen Kaese bestreuen. Weitere 15 - 20 Minuten backen, bis der Kaese eine schoene Farbe hat.Kann als Flammkuchen oder als Rolle gegessen werden.Der Flammkuchen hat ca. 6 g Kohlenhydrate.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Fleisch waschen und trocken tupfen. Mit Salz und Pfeffer wuerzen. Öl in einer Pfanne erhitzen. Filets darin von allen Seiten ca. 5 Min. kraeftig anbraten.Tomaten waschen und halbieren. Basilikumblaetter abzupfen, waschen und fein hacken.Sahne in einem Topf aufkochen lassen. Schmelzkaese hineinruehren und schmelzen lassen. Mit Salz und Pfeffer wuerzen. 2/3 vom Basilikum unterruehren.Fleisch und Tomaten in eine gefettete Auflaufform geben. Sauce darueber giessen. Mozzarella in kleine Stueckchen schneiden und auf dem Fleisch verteilen. Wer mag, kann noch geriebenen Parmesan und 1 EL Kraeuterbutter in kleine Floeckchen darauf verteilen.Im vorgeheizten Ofen bei 200 °C Ober-/Unterhitze bzw. 175 °C Umluft ca. 30 Min. backen. Herausnehmen und mit restlichem Basilikum bestreuen.Dazu schmecken Kroketten oder Reis.")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Zubereitung:Backofen auf 180°C vorheizen. Zwiebel abziehen und in Wuerfel schneiden. Lauch putzen, waschen und in halbe Ringe schneiden. Zucchini und Tomaten waschen, halbieren und Zucchini zusaetzlich in Scheiben schneiden.Öl in einer Pfanne erhitzen und Zwiebelwuerfel darin anbraten. Hackfleisch dazugeben und kraeftig anbraten. Lauch und Zucchini hinzufuegen und mitduensten. Passierte Tomaten angiessen, Kirschtomaten unterheben, mit Salz und Cayennepfeffer abschmecken.Kartoffelnudeln in Portionsauflaufformen geben und mit der Sauce uebergiessen.Auflaeufe mit Kaese bestreuen und im vorgeheizten Backofen 15-20 Minuten backen (Gas: Stufe 3, Umluft 160°C).Zubereitungszeit: 30 MinutenBackzeit: 15-20 MinutenPro Portion (bei 3 Portionen):kJ/kcal: 3647/871EW: 46,5 gF: 47,0 gKH: 66,0 gBE: 5,0")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="1. Wirsing putzen, waschen und in Streifen, Kasseler in Wuerfel schneiden. Zwiebeln abziehen und in Ringe schneiden. Öl erhitzen, Zwiebeln dazugeben, goldbraun braten und herausnehmen. Wirsing in das verbliebene Bratfett geben und anduensten. Bruehe angiessen, Kasseler und gebratene Zwiebeln dazugeben und abgedeckt ca. 20 Min. garen.2. Schupfnudeln und Schmand untermischen und alles mit Senf, Liebstoeckel, Salz, Pfeffer und Kuemmel abschmecken.3. Mischung in eine Gratinform (20 x 30 cm) geben, Kaese ueberstreuen und im vorgeheizten Backofen bei 200 °C (Gas: Stufe 4, Umluft 180 °C) ca. 25-30 Min. goldbraun ueberbacken. Schnittlauch ueberstreuen und servieren.Pro Portion (bei 6 Portionen):kJ/kcal: 2.322/555EW: 24,3 gF: 24,5 gKH: 59,2 gBE: 4,5")
db.session.add(handob)
db.session.commit()
...
handob = handlungsschritt(text="Sauerrahm und Crème fraîche mit der Bruehe verruehren und diese Mischung in eine grosse Auflaufform fuellen.Die Kartoffeln gut waschen und mehrfach einschneiden, aber nicht ganz durchschneiden - sie sollen an der Unterseite noch zusammenhaengen. Die Abstaende zwischen den Schnitten sollten so aehnlich sein wie bei einem Eierschneider.Die Kartoffeln mit der geschnittenen Seite nach oben in die Form setzen. Aber nur nebeneinander - nicht uebereinander - stapeln, sodass sie etwa zur Haelfte in der Sosse sitzen.Im heissen Backofen bei 200 °C Ober-/Unterhitze ca. 45 - 60 Minuten backen, bis die Kartoffeln fast gar sind.In der Zwischenzeit die Butter zerlassen. Katenschinken und Rosmarin hinzufuegen sowie die Toastbrotwuerfel dazumischen. Diese Mischung auf den Kartoffeln verteilen und noch einmal so lange backen, bis die Brotwuerfel schoen braun sind und die Kartoffeln gar.Dazu Blattsalat servieren.")
db.session.add(handob)
db.session.commit()
