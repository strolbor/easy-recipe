...
def admin():
    ...
    return render_template('adminindex.html',admA=True)
...
def addrezept():
    ...
    return render_template('newrezept.html',form=form,admB=True)

@app.route('/admin/addhandlungsschritt')
def addhandlung():
    """Dies ist der Admin Hauptindex"""
    return render_template('adminindex.html',admC=True)

@app.route('/admin/modifyRZ')
def CHGverknupfung():
    """Dies ist der Admin Hauptindex"""
    return render_template('adminindex.html',admD=True)

@app.route('/admin/addZutat')
def addZutat():
    """Dies ist der Admin Hauptindex"""
    return render_template('adminindex.html',admE=True)