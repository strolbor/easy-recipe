...
def remover(mode: int, classes, redirect_url: str):
    ...
    if mode == MODE_ZUTATEN:
        ...
        return (render_template('admin_remove.html', inhalt=liste.items, titlet="Verknüpfungsmanipulation: Zutaten & Rezept", MODE_REZEPTadd=True, next_url=next_url, prev_url=prev_url, page=page))
    else:
